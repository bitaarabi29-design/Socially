...
const NotificationCard: React.FC<NotificationCardProps> = ({
  ...
  const getIcon = () => {
    switch (type) {
      case "like":
        return <FaHeart className="text-xs text-red-500" />;
      case "comment":
      default:
        return <FaComment className="text-xs text-blue-500" />;
    }
  };

  return (
    <div className="border-base-300 flex items-start gap-4 border-b p-4">
      {/* Avatar با آیکون در پایین - دقیقاً مثل PDF */}
      <div className="relative top-0">
        ...
        {/* آیکون در پایین و سمت راست آواتار */}
